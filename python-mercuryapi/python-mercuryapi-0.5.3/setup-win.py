...
mercuryapi = "D:/coding/mercuryapi-1.35.2.72/c/src/"
...
setup(name="mercuryapi", version="0.5.3",
      ext_modules=[Extension("mercury",
                             ...
                             #library_dirs=[mercuryapi + 'pthreads-win32/x86']
                              library_dirs=[mercuryapi + "D:/coding/UHF-HAT-for-RaspberryPi/python-mercuryapi/python-mercuryapi-0.5.3/mercuryapi-AHAB-1.35.2.72/mercuryapi-1.35.2.72/c/src/pthreads-win32/pthreads.2/pthreadVC2.lib"]
                  )],
      # FIXME: update to include the path to pthreadVC2.dll
      #data_files = [('', [mercuryapi + 'pthreads-win32/x86/pthreadVC2.dll'])])
      data_files = [('', [mercuryapi + "D:/coding/UHF-HAT-for-RaspberryPi/python-mercuryapi/python-mercuryapi-0.5.3/mercuryapi-AHAB-1.35.2.72/mercuryapi-1.35.2.72/c/src/pthreads-win32/pthreads.2/pthreadVC2.dll"])])
